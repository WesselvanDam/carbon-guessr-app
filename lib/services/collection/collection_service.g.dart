...
class _CollectionService implements CollectionService {
  _CollectionService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<CollectionsResponse> fetchAllCollections() async {
  ...
  @override
  Future<Source> fetchSource(String collectionId, int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<LocalizationData> fetchLocalizationData(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LocalizationData>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${collectionId}/l10n/${locale}/${id}.json',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LocalizationData _value;
    try {
      _value = LocalizationData.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
